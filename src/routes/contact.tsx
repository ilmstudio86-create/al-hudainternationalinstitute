          ...
          <div className="space-y-5">
            <div className="rounded-xl bg-gradient-primary p-7 text-primary-foreground relative overflow-hidden">
              ...
              <div className="relative space-y-5">
                ...
                <div className="flex items-start gap-3"><Mail className="h-5 w-5 text-gold mt-0.5" /><div><div className="text-xs uppercase tracking-wider text-primary-foreground/70">Email</div><div className="font-medium">info@alhudaislamicinstitute.com</div></div></div>
